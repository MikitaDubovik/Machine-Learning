...
% %     email_contents = strcat(email_contents, ' ', file);
% %     
% % % Lower case
...
first = randperm(2500);
second = randperm(2500);

for k=1:2500
    tempY = y(first(k),:);
    y(first(k),:) = y(second(k),:);
    y(second(k),:) = tempY;
